            ...
            <div class="col-6 col-md-12">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-start">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Invoices (Piutang)</li>
                    </ol>
                </nav>
            </div>
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Invoices (Piutang)</h3>
                <p class="text-subtitle text-muted">Manage Invoice</p>
            </div>
        </div>
    </div>
                            ...
                            <tr>
                                <td>
                                    <div style="font-size:13px">
                                        <span class="fw-bold" >{{$invoice->no}}</span><br/>
                                        {{$invoice->date}}
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <button type="button" class="btn btn-sm btn-outline-secondary d-flex align-items-center justify-content-center" style="aspect-ratio:1/1;" data-bs-toggle="modal"
                                            data-bs-target="#addressModal-{{$invoice->id}}">
                                        ...
                                        {{-- Modal Products --}}
                                        <div class="modal fade" id="addressModal-{{$invoice->id}}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body border-0 py-0">
                                                        <a href="{{asset('storage/'.$invoice->po_file)}}" target="_blank" class="mb-4 bg-primary text-white p-1 px-2 rounded-3 d-flex gap-2 align-items-center justify-content-between">
                                                            <div>
                                                            ...
                                                            <div class="w-100" style="display: -webkit-box;
                                                                                ...
                                                                                -webkit-line-clamp: 1;">
                                                                Refrence : {{$invoice->purchaseOrder->po_number}}
                                                            </div>
                                                        </a>
                                                        <div>
                                        ...
                                        <div>
                                            <div class="fw-semibold">
                                                @if($invoice->client)
                                                    {{ $invoice->client->trashed() ? '[Deleted] ' : '' }}{{ $invoice->client->name }}
                                                @else
                                ...
                                <td>
                                    ...
                                    <button type="button" class="border-0 outline-0 bg-transparent text-primary gap-2 d-flex align-items-center justify-content-center" data-bs-toggle="modal"
                                        data-bs-target="#productModal-{{$invoice->id}}">
                                    ...
                                    {{-- Modal Address --}}
                                    <div class="modal fade" id="productModal-{{$invoice->id}}" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                                            role="document">
                                            <div class="modal-content">
                                ...
                                <td style="width: 5em">
                                    <div class="d-flex align-items-center gap-1">
                                        <a href="{{route('purchase.show', $invoice->purchaseOrder->id)}}" title="Go to Purchase Order Detail" class="btn btn-sm btn-success block" style="aspect-ratio:1/1">
                                        ...
                                        <a href="{{route('invoice.print', $invoice->id)}}" title="Print" class="btn btn-sm btn-danger block" style="aspect-ratio:1/1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                        ...
                                        <a href="{{route('invoice.show', $invoice->id)}}" class="btn btn-sm btn-primary block" title="Setting Invoice" style="aspect-ratio:1/1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20">
