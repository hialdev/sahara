...
@section('description', 'Add Client or Customer with PIC Contact')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="npwp" name="npwp" required class="form-control" value="{{old('npwp')}}" placeholder="NPWP Number">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <span style="font-size:10px; white-space:nowrap" class="text-uppercase">Client Address</span>
                            <hr class="d-block bg-dark w-100 border-0 outline-0" style="height:2px;">
                        </div>
                        <div class="mb-3">
