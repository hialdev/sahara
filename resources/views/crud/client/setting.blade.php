...
@section('title', 'Setting Client : '.$client->name)
@section('description', 'Setting Client or Supplier with PIC Contact')
...
@section('form')
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-4">
                    ...
                    <h6 class="mb-0">{{$client->name}} - {{$client->email}}</h6>
                    <p class="mb-0" style="font-size: 12px">{{$client->description}}</p>
                </div>
                <div class="col-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <div class="d-flex align-items-center justify-content-center rounded-2 bg-primary text-white p-2" style="aspect-ratio:1/1">
                    ...
                    <h6 class="mb-0">{{$client->contact_name}}</h6>
                    <p class="mb-0" style="font-size: 12px">Email : {{$client->contact_email}}</p>
                    <p class="mb-0" style="font-size: 12px">Phone : {{$client->contact_phone}}</p>
                </div>
                <div class="col-md-4 text-end">
                    <button type="button" class="btn btn-sm btn-outline-danger block d-flex align-items-center gap-2 mb-1 ms-auto" data-bs-toggle="modal"
                        data-bs-target="#danger-{{$client->id}}">
                    ...
                    <p class="mb-0" style="font-size: 12px"><span class="text-danger">*</span> Mohon perhatikan effek yang ditimbulkan dari menghapus client, seperti transaksi Purchase Order yang terkait dengan client ini.</p>
                </div>
                {{-- Modal Delete --}}
                <div class="modal fade text-left" id="danger-{{$client->id}}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                        ...
                        <div class="modal-content rounded-4">
                            ...
                            <div class="modal-body border-0">
                                Apakah anda yakin menghapus data client <strong> {{$client->name}}</strong> ?
                            </div>
    ...
    <div class="d-flex align-items-center gap-4">
        ...
        <div class="d-flex align-items-center justify-content-center bg-primary text-white rounded-5 p-2" style="aspect-ratio:1/1 !impportant; width:2em">{{count($client->purchaseOrders)}}</div>
    </div>

    @forelse ($client->purchaseOrders as $processed)
        <div class="card mb-2">
            <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    ...
                                    @else
                                    <span class="text-muted">Logistic diurus oleh client<br/></span>
                                    @endif
