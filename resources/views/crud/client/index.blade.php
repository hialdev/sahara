    ...
    <div class="page-title">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Client</h3>
                <p class="text-subtitle text-muted">Manage client</p>
            </div>
            <div class="col-6 order-md-2 order-1">
                <a href="{{route('client.add')}}" class="btn btn-primary float-end">Add New</a>
            </div>
        </div>
    </div>
                    ...
                    <table class="table" id="table2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <button type="button" class="btn btn-sm btn-outline-secondary d-flex align-items-center justify-content-center" style="aspect-ratio:1/1;" data-bs-toggle="modal"
                                            data-bs-target="#addressModal-{{$client->id}}">
                                        ...
                                        {{-- Modal Address --}}
                                        <div class="modal fade" id="addressModal-{{$client->id}}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body border-0 py-0">
                                                        ...
                                                        @empty
                                                        Address not found for this client
                                                        @endforelse
                                                    </div>
                                ...
                                <td style="max-width: 10em; font-size:12px">{{$client->description}}</td>
                                <td>
                                ...
                                <td style="width: 5em">
                                    <div class="d-flex align-items-center gap-1">
                                        <a href="{{route('client.edit', $client->id)}}" class="d-flex align-items-center justify-content-center btn btn-sm btn-outline-primary block" style="aspect-ratio:1/1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                            ...
                                            <div class="modal-content rounded-4">
                                                ...
                                                <div class="modal-body border-0">
                                                    Apakah anda yakin menghapus data client dengan id {{$client->id}} ? data yang dihapus bersifat permanen tidak dapat dikembalikan
                                                </div>
                                                <div class="modal-footer border-0">
                                                    <button type="button" class="btn btn-light-secondary"
                                                        data-bs-dismiss="modal">
