...
<div>
    <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="client-tab" data-bs-toggle="tab" href="#client" role="tab"
                aria-controls="client" aria-selected="true">Client</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="address-tab" data-bs-toggle="tab" href="#address" role="tab"
                aria-controls="address" aria-selected="false">Client Address</a>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="name" required class="form-control" value="{{old('name', $client->name)}}" placeholder="client or Supplier Name">
                                </div>
                                <div class="mb-3">
                                    <label for="npwp" class="form-label">NPWP <span class="text-danger">*</span></label>
                                    <input type="number" id="npwp" name="npwp" required class="form-control" value="{{old('npwp', $client->npwp)}}" placeholder="NPWP Number">
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                                    <input type="email" id="email" name="email" required class="form-control" value="{{old('email', $client->email)}}" placeholder="email@mail.com">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Description</label>
                                    <textarea name="description" id="description" cols="30" rows="3" class="form-control">{{old('description', $client->description)}}</textarea>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="contact_name" required value="{{old('contact_name', $client->contact_name)}}" class="form-control" placeholder="PIC Name">
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                                    <input type="email" id="email" name="contact_email" required value="{{old('contact_email', $client->contact_email)}}" class="form-control" placeholder="pic@email.com">
                                </div>
                                <div class="">
                                    <label for="tel" class="form-label">Phone <span class="text-danger">*</span></label>
                                    <input type="tel" id="tel" name="contact_phone" required value="{{old('contact_phone', $client->contact_phone)}}" class="form-control" placeholder="No Telp">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="tab-pane fade" id="address" role="tabpanel" aria-labelledby="address-tab">
            <div class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                            ...
                                            <div class="modal-content rounded-4">
                                                ...
                                                <div class="modal-body border-0">
                                                    Apakah anda yakin menghapus data alamat pada client {{$client->name}} dengan id {{$client->id}} ? data yang dihapus bersifat permanen tidak dapat dikembalikan
                                                </div>
                                                <div class="modal-footer border-0">
                                                    ...
                                                    <form action="{{route('client.address.destroy', ['client_id' => $client->id, 'id' => $address->id])}}" method="POST">
                                                        @csrf
                                                        @method('delete')
                ...
                <div class="col-md-6">
                    <form action="{{route('client.address.manage', ['client_id' => $client->id])}}" method="POST">
                        @csrf
