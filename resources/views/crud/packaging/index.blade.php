                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                        ...
                                        <div class="modal-content rounded-4">
                                            ...
                                            <div class="modal-footer border-0">
                                                ...
                                                <form action="{{route('packaging.destroy', $item->id)}}" method="POST">
                                                    @csrf
                                                    @method('delete')
    ...
    <div class="modal fade text-left" id="deleteModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
            ...
            <div class="modal-content rounded-4">
                ...
                <div class="modal-body border-0">
                    Apakah anda yakin menghapus data packaging : <span class="packaging-title fw-semibold"></span> ? data yang dihapus bersifat permanen tidak dapat dikembalikan
                </div>
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-light-secondary"
                        data-bs-dismiss="modal">
...
<script>
    $(document).ready(function() {
        ...
        $('#deleteModal').on('show.bs.modal', function (event) {
            ...
            // Masukkan data ke dalam form modal
            var modal = $(this);
            modal.find('span.packaging-title').text(name); // Update nama produk

            // Ubah action form sesuai ID produk
            modal.find('form').attr('action', '/packaging/' + id + '/destroy');
        });
    });
</script>
@endsection