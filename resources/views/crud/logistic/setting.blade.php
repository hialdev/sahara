@extends('templates.crud.add', ['routeName'=>'logistic', 'routeId' => $logistic->id])

@section('title', 'Setting Logistic : '.$logistic->name)
@section('description', 'Setting Logistic or Supplier with PIC Contact')
...
@section('form')
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-4">
                    ...
                    <h6 class="mb-0">{{$logistic->name}} - {{$logistic->email}}</h6>
                    <p class="mb-0" style="font-size: 12px">{{$logistic->description}}</p>
                </div>
                <div class="col-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <div class="d-flex align-items-center justify-content-center rounded-2 bg-primary text-white p-2" style="aspect-ratio:1/1">
                    ...
                    <h6 class="mb-0">{{$logistic->contact_name}}</h6>
                    <p class="mb-0" style="font-size: 12px">Email : {{$logistic->contact_email}}</p>
                    <p class="mb-0" style="font-size: 12px">Phone : {{$logistic->contact_phone}}</p>
                </div>
                <div class="col-md-4 text-end">
                    ...
                    <p class="mb-0" style="font-size: 12px"><span class="text-danger">*</span> Mohon perhatikan effek yang ditimbulkan dari menghapus Logistic, seperti transaksi Purchase Order yang terkait dengan Logistic ini.</p>
                </div>
                {{-- Modal Delete --}}
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                        ...
                        <div class="modal-content rounded-4">
                            ...
                            <div class="modal-body border-0">
                                Apakah anda yakin menghapus data Logistic <strong> {{$logistic->name}}</strong> ?
                            </div>
    ...
    <div class="d-flex align-items-center gap-4">
        ...
        <div class="d-flex align-items-center justify-content-center bg-primary text-white rounded-5 p-2" style="aspect-ratio:1/1 !impportant; width:2em">{{count($logistic->purchaseOrders)}}</div>
    </div>

    @forelse ($logistic->purchaseOrders as $processed)
        <div class="card mb-2">
            <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    ...
                                    @else
                                    <span class="text-muted">Logistic diurus oleh Logistic<br/></span>
                                    @endif
