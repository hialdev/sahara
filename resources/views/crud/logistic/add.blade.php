...
@section('title', 'Add Logistic')
@section('description', 'Add Logistic or Customer with PIC Contact')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="name" class="form-label">Logistic Name <span class="text-danger">*</span></label>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <span style="font-size:10px; white-space:nowrap" class="text-uppercase">Logistic Office Address</span>
                            <hr class="d-block bg-dark w-100 border-0 outline-0" style="height:2px;">
                        </div>
                        <div class="mb-3">
