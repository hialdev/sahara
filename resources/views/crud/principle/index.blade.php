                            ...
                            <tr>
                                ...
                                <td style="width: 5em">
                                    <div class="d-flex align-items-center gap-1">
                                        <a href="{{route('principle.edit', $principle->id)}}" class="d-flex align-items-center justify-content-center btn btn-sm btn-primary block" style="aspect-ratio:1/1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                        ...
                                        <a href="{{route('principle.setting', $principle->id)}}"
