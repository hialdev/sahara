                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body border-0 py-0">
                                                        @forelse ($quotation->addresses as $address)
                                        ...
                                        <div>
                                            ...
                                            <div style="font-size:12px" class="text-secondary">{{$quotation->email}}</div>
                                        </div>
                                    </div>
                                </td>
                                <td style="max-width: 10em; font-size:12px">{{$quotation->description}}</td>
                                <td>
                                    <div class="fw-semibold">
                                        {{$quotation->contact_name}}
                                    </div>
                                    <div style="font-size:12px" class="text-secondary">{{$quotation->contact_email}}, {{$quotation->contact_phone}}</div>
                                </td>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                            ...
                                            <div class="modal-content rounded-4">
                                                ...
                                                <div class="modal-body border-0">
                                                    Apakah anda yakin menghapus data quotation dengan id {{$quotation->id}} ? data yang dihapus bersifat permanen tidak dapat dikembalikan
                                                </div>
                                                <div class="modal-footer border-0">
                                                    <button type="button" class="btn btn-light-secondary"
                                                        data-bs-dismiss="modal">
