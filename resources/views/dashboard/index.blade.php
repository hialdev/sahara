                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{$count['apps']}}</h6>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div class="card-body px-4 py-4-5">
                        <div class="d-flex align-items-start flex-column justify-content-between h-100">
                            <div class="w-100">
                              ...
                              @else
                              <img src="{{Storage::url($app->image)}}" alt="Image of {{$app->title}}" class="d-block rounded-3 mb-3 w-100" style="background:#f7f7f7;aspect-ratio:16/9; object-fit:contain; ">
                              @endif
