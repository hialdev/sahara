...
class Invoice extends Model
{
    ...
    protected $fillable = ['no', 'receivable_account_id', 'revenue_account_id' , 'date', 'po_file', 'client_id', 'total_invoice', 'purchase_order_id', 'description'];
    ...
    public function sisaPiutang(){
        ...
        return $this->total_invoice - $totalPaid;
    }
